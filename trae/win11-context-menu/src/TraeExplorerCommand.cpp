...
// {B8B07D8E-1327-41D0-86ED-DC7E1A243B3D}
static const CLSID CLSID_TraeExplorerCommand =
{ 0xb8b07d8e, 0x1327, 0x41d0, { 0x86, 0xed, 0xdc, 0x7e, 0x1a, 0x24, 0x3b, 0x3d } };

static volatile LONG g_dllRefCount = 0;
static const wchar_t kSettingsKey[] = L"Software\\Classes\\TraeContextMenu";
static const wchar_t kFallbackTitle[] = L"Open with Trae";
...
STDAPI DllGetClassObject(REFCLSID clsid, REFIID riid, void** object) {
	if (!IsEqualCLSID(clsid, CLSID_TraeExplorerCommand)) {
