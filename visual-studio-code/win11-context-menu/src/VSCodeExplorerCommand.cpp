...
// {0D3AA95C-38CC-410B-AD0D-D4C74EC3C2B1}
static const CLSID CLSID_VSCodeExplorerCommand =
{ 0x0d3aa95c, 0x38cc, 0x410b, { 0xad, 0x0d, 0xd4, 0xc7, 0x4e, 0xc3, 0xc2, 0xb1 } };

static volatile LONG g_dllRefCount = 0;
static const wchar_t kSettingsKey[] = L"Software\\Classes\\OpenWithVSCodeContextMenu";
static const wchar_t kFallbackTitle[] = L"Open with Code";
...
STDAPI DllGetClassObject(REFCLSID clsid, REFIID riid, void** object) {
	if (!IsEqualCLSID(clsid, CLSID_VSCodeExplorerCommand)) {
